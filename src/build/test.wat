(module
 ...
 (global $assembly/index/lemmings (mut i32) (i32.const 64))
 ...
 (func $assembly/levels/baseLevel/BaseLevel#set:numberOfLemmings (param $0 i32) (param $1 i32)
  local.get $0
  local.get $1
  i32.store8
 )
 (func $assembly/lemming/Lemming#set:action (param $0 i32) (param $1 i32)
  local.get $0
  local.get $1
  i32.store
  local.get $0
 ...
 (func $assembly/lemming/Lemming#set:isClimber (param $0 i32) (param $1 i32)
  local.get $0
  local.get $1
  i32.store8 offset=4
 )
 ...
 (func $~lib/array/Array<assembly/lemming/Lemming>#set:length_ (param $0 i32) (param $1 i32)
  local.get $0
  local.get $1
  i32.store offset=12
 )
 (func $~lib/array/Array<assembly/lemming/Lemming>#push (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (local $3 i32)
  local.get $0
  i32.load offset=12
  ...
  local.get $0
  local.get $3
  call $~lib/array/Array<assembly/lemming/Lemming>#set:length_
  local.get $3
 )
 (func $~lib/array/Array<assembly/lemming/Lemming>#get:length (param $0 i32) (result i32)
  local.get $0
  i32.load offset=12
 )
 (func $assembly/actions/lemmingAction/LemmingAction#label (param $0 i32) (result i32)
  unreachable
 )
 (func $assembly/actions/lemmingAction/LemmingAction#update (param $0 i32) (param $1 i32)
  unreachable
 )
 (func $assembly/levels/level/Level#gameLoop (param $0 i32) (result i32)
  local.get $0
 ...
 (func $assembly/index/start
  ...
  global.set $assembly/index/lemmings
  global.get $~lib/memory/__stack_pointer
  i32.const 0
  call $assembly/index/Level1#constructor
  local.tee $1
  i32.store
  loop $while-continue|0
   i32.const 1
 ...
 (func $assembly/actions/lemmingAction/LemmingAction#label@virtual (param $0 i32) (result i32)
  ...
  block $default
   ...
   local.get $0
   call $assembly/actions/fall/Fall#label
   return
  end
  unreachable
 )
 (func $assembly/actions/fall/Fall#update (param $0 i32) (param $1 i32)
  local.get $1
  i32.const 0
  call $assembly/actions/walk/Walk#constructor
  call $assembly/lemming/Lemming#set:action
 )
 (func $assembly/actions/lemmingAction/LemmingAction#handleClimbing (param $0 i32) (param $1 i32)
  local.get $1
  i32.const 0
 ...
 (func $assembly/actions/walk/Walk#update (param $0 i32) (param $1 i32)
  local.get $0
  local.get $1
  call $assembly/actions/lemmingAction/LemmingAction#handleClimbing
 )
 (func $assembly/actions/climb/Climb#update (param $0 i32) (param $1 i32)
  nop
 )
 (func $assembly/actions/lemmingAction/LemmingAction#update@virtual (param $0 i32) (param $1 i32)
  (local $2 i32)
  block $default
   block $case2
    block $case1
     ...
     local.get $0
     local.get $1
     call $assembly/actions/fall/Fall#update
     return
    end
    local.get $0
    local.get $1
 ...
 (func $assembly/lemming/Lemming~visit (param $0 i32) (param $1 i32)
  (local $2 i32)
  local.get $0
  i32.load
  local.tee $2
 ...
 (func $~lib/array/Array<assembly/lemming/Lemming>#__visit (param $0 i32) (param $1 i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
 ...
 (func $~lib/array/Array<assembly/lemming/Lemming>~visit (param $0 i32) (param $1 i32)
  local.get $0
  local.get $1
  call $~lib/array/Array<assembly/lemming/Lemming>#__visit
 )
 ...
 (func $~lib/rt/__visit_members (param $0 i32) (param $1 i32)
  block $invalid
   block $assembly/actions/climb/Climb
    block $assembly/actions/walk/Walk
     block $assembly/actions/fall/Fall
      block $assembly/levels/baseLevel/BaseLevel
       block $assembly/levels/level/Level
        block $assembly/index/Level1
         block $~lib/array/Array<i32>
          block $~lib/array/Array<assembly/lemming/Lemming>
           block $assembly/actions/lemmingAction/LemmingAction
             ...
             block $~lib/arraybuffer/ArrayBufferView
              block $~lib/string/String
               block $~lib/arraybuffer/ArrayBuffer
                ...
                i32.sub
                i32.load
                br_table $~lib/arraybuffer/ArrayBuffer $~lib/string/String $~lib/arraybuffer/ArrayBufferView $assembly/lemming/Lemming $assembly/actions/lemmingAction/LemmingAction $~lib/array/Array<assembly/lemming/Lemming> $~lib/array/Array<i32> $assembly/index/Level1 $assembly/levels/level/Level $assembly/levels/baseLevel/BaseLevel $assembly/actions/fall/Fall $assembly/actions/walk/Walk $assembly/actions/climb/Climb $invalid
               end
               return
              end
              return
            ...
            local.get $0
            local.get $1
            call $assembly/lemming/Lemming~visit
            return
           end
           return
          end
          local.get $0
          local.get $1
          call $~lib/array/Array<assembly/lemming/Lemming>~visit
          return
         end
         local.get $0
         local.get $1
 ...
 (func $assembly/levels/level/Level#constructor (param $0 i32) (result i32)
  (local $1 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 12
  i32.sub
  ...
  i32.store offset=8
  local.get $1
  call $~lib/array/Array<assembly/lemming/Lemming>#push
  drop
  local.get $0
  local.set $1
  global.get $~lib/memory/__stack_pointer
 ...
 (func $assembly/levels/level/Level#processLemmingSelect (param $0 i32) (result i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
  global.get $~lib/memory/__stack_pointer
  ...
  loop $for-loop|0
   ...
   i32.store
   local.get $3
   call $~lib/array/Array<assembly/lemming/Lemming>#get:length
   i32.lt_s
   local.set $2
   local.get $2
   if
    ...
    i32.store offset=4
    local.get $3
    call $assembly/actions/lemmingAction/LemmingAction#label@virtual
    local.set $3
    global.get $~lib/memory/__stack_pointer
    local.get $3
    i32.store
 ...
 (func $assembly/lemming/Lemming#update (param $0 i32)
  (local $1 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.sub
 ...
 (func $assembly/levels/level/Level#updateLemmings (param $0 i32)
  ...
  loop $for-loop|0
   ...
   if
    ...
    i32.store
    local.get $3
    call $assembly/lemming/Lemming#update
    local.get $1
    i32.const 1
    i32.add
    local.set $1
 ...
 (func $assembly/levels/baseLevel/BaseLevel#constructor (param $0 i32) (result i32)
  (local $1 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.sub
  ...
  local.get $0
  i32.const 1
  call $assembly/levels/baseLevel/BaseLevel#set:numberOfLemmings
  local.get $0
  local.set $1
  global.get $~lib/memory/__stack_pointer
  i32.const 4
 ...
 (func $assembly/actions/lemmingAction/LemmingAction#constructor (param $0 i32) (result i32)
  (local $1 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.sub
 ...
 (func $assembly/actions/fall/Fall#constructor (param $0 i32) (result i32)
  (local $1 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.sub
 ...
 (func $assembly/lemming/Lemming#constructor (param $0 i32) (result i32)
  (local $1 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.sub
 ...
 (func $assembly/index/Level1#constructor (param $0 i32) (result i32)
  (local $1 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.sub
 ...
 (func $~lib/array/Array<assembly/lemming/Lemming>#__get (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (local $3 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 4
 ...
 (func $assembly/actions/walk/Walk#constructor (param $0 i32) (result i32)
  (local $1 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.sub
 ...
 (func $assembly/actions/climb/Climb#constructor (param $0 i32) (result i32)
  (local $1 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.sub
